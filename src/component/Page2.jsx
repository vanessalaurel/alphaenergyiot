...
const Page2 = () => {
  return (
    <div>
      ...
      <div classname="flex">
        <img className=" ml-[4%] w-[50%] " src={p2} alt="" />
        <div className=" text-black ml-[4%]">
          <h1 className="text-4xl font-mono">Package 2</h1>
          <h1 className="font-extralight">SKU: 0002</h1>
          <h1 className="font-thin text-2xl mt-[4%]">HK$6,240.00</h1>
      ...
      <div className="flex ml-[4%] mt-[2%]">
        <div>
          <h1 className="text-xl">Package 2</h1>
          <h1 className="font-extralight">
            ...
            model Price (per month): 6,240 HKD (per project, 10k users) + 78 HKD
            (per beacon)
          </h1>
        </div>
